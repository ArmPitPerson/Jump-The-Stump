...
public:
	AMainGame(sf::RenderWindow& W, JumpTheStumpGame& G) : AScene(W, G) {
		...
		ScanlineFragShader.loadFromFile("Scanline.frag", sf::Shader::Fragment);
		ScanlineFragShader.setUniform("texture", sf::Shader::CurrentTexture);
		PreRenderedImage.create(1600, 900);
	}
...
private:
	...
	sf::Texture PreRenderedImage;
	sf::Shader ScanlineFragShader;
